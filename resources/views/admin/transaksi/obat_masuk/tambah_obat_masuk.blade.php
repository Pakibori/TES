        ...
        <div class="col-md-10 grid-margin stretch-card">
            <div class="card">
                <h6 class="card-header">Tambah Obat masuk
                    <a href="/obat_masuk" class=" btn btn-primary float-lg-right">
                        <i class="link-icon" data-feather="corner-up-left"></i>
                        Kembali
                    </a>
                </h6>
                <form method="POST" enctype="multipart/form-data" action="{{ url('/simpan_obat_masuk') }}">
                    @csrf
                    <div class="card-body">
                          
                            <div class="form-group">
                                <label for="exampleInputPassword1">Kode Tansaksi</label>
                                <input type="text" name="kd_transaksi" class="form-control"  placeholder="Kode_Obat" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-single w-100 form-control" name="id_obat" id="id_obat">
                                    <option  value="" hidden>--Pilih kategori--</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number"  name="jumlah_masuk"class="form-control" placeholder="Jumlah Masuk" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="keterangan" id="keterangan" cols="50" rows="10" class="form-control" placeholder=" Keterangan"></textarea>
                            </div>
