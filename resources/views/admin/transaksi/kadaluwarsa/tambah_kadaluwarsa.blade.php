        ...
        <div class="col-md-10 grid-margin stretch-card">
            <div class="card">                              
                <h6 class="card-header">Tambah kadaluwarsa </h6> 
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ url('/simpan_kadaluwarsa') }}">
                        @csrf 
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Kode Obat</label>
                                    <input type="text"  name="kode_exp"class="form-control" placeholder=" Kode Exp Obat" required>
                                </div>
                                <div class="form-group">
                                    <label>Obat</label>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="js-example-basic-single w-100 form-control" name="id_obat_masuk">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date"  name="tanggal_exp"class="form-control" placeholder="" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="exampleFormControlTextarea1" name="keterangan" rows="8"></textarea>
                            </div>                          
