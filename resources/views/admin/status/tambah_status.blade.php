        ...
        <div class="col-md-10 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <form method="POST" enctype="multipart/form-data" action="{{ url('/simpan_status') }}">
                            @csrf 
                            <div class="form-group">
                                <label for="exampleInputEmail1">Status Admin</label>
                                <input type="text"  name="status_admin"class="form-control" placeholder="Status Admin" required>
                            </div>
                           
                            <div class="form-group">
                                <label for="exampleInputPassword1">Status Dinas</label>
                                <input type="text" name="status_dinas" class="form-control"  placeholder="Status Kepala dinas" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Status Gudang</label>
                                <input type="text" name="status_gudang" class="form-control"  placeholder="Status kepala gudang" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Status Puskesmas Pustu</label>
                                <input type="text" name="status_puskesmas" class="form-control"  placeholder="Status Puksesmas" required>
                            </div>
