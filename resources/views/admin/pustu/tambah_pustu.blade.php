        ...
        <div class="col-md-10 grid-margin stretch-card">
            <div class="card">                              
                <h6 class="card-header">Tambah Kategori </h6> 
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ url('/simpan_pustu') }}">
                        @csrf 
                            <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Nama Puskesmas atau Pustu</label>
                                <input type="text"  name="nama_pus"class="form-control" placeholder="Nama Puskesmas atau Pustu" required>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Email Puskesmas atau Pustu</label>
                                <input type="email"  name="email_pus"class="form-control" placeholder="Email Puskesmas atau Pustu" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Alamat Puskesmas atau Pustu</label>
                                <input type="text"  name="alamat_pus"class="form-control" placeholder="Alamat Puskesmas atau Pustu" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">No. Telp Puskesmas atau Pustu</label>
                                <input type="number"  name="no_telp_pus"class="form-control" placeholder="No Telp Puskesmas atau Pustu" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Nama Kepala Puskesmas atau Pustu</label>
                                <input type="text"  name="kepala_pus"class="form-control" placeholder="Nama kepala Pustukesmas atau Pustu" required>
                            </div>                          
